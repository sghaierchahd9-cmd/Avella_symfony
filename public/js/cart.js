...
(() => {
    ...
    function refreshCartBody() {
        return fetch(dir() + 'buyer/cart.php?cart_fragment=1', { credentials: 'same-origin' })
            .then(r => r.text())
            .then(html => {
                if (!cartBody) return;
    ...
    function addToCart(produitId, qty) {
        ...
        fetch(dir() + 'buyer/add-to-cart.php', {
            method: 'POST',
    ...
    function updateItem(cpId, action, triggerEl) {
        ...
        fetch(dir() + 'buyer/update-cart.php', {
            method: 'POST',
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
    ...
    function handleConfirmOrder() {
        ...
        fetch(dir() + 'buyer/confirm_order.php', {
            method: 'POST',
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
